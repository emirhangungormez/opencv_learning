# Grabcut fonksiyonu kullanilarak maskeleme islemi ile ilgilendigimiz
# resimden odaklandigimiz bolum cikarilip baska bir resim ile
# ortak bir noktada ayni zemine koyulmustur.

import cv2 as cv
import numpy as np

src = cv.imread("Image-Process\merve.jpg")
...
background = cv.imread("Image-Process\homelander.jpg")
...
cv.imshow("result", result.astypenp.uint8)
cv.waitKey(0)