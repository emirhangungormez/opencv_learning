# Videolarda hareket eden nesneleri takip edilerek
# arka plandan ayrilmasi işlemi gösterilmiştir.

import cv2 as cv
import numpy as np

cap = cv.VideoCapture("Image-Process\walking.mp4")
...
def process(image):
    ...
    for c in range(len(contours)):
        ...
        cv.ellipse(image, rect, (0, 255, 0), 2, 0)
